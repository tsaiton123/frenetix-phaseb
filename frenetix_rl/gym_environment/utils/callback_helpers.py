...
class TqdmCallback(BaseCallback):
    """Progress bar over total_timesteps.

    Uses tqdm.auto, so it renders as a widget in Colab/Jupyter and as a plain
    text bar in a terminal. Tracks self.num_timesteps (total across vec envs).
    """
    ...
    def _on_step(self) -> bool:
        # num_timesteps jumps by num_envs each collection step; set absolute value
